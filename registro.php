...
<head>
  ...
  <!-- Inter (parecida al estilo del mockup) -->
  ...
  <style>
    :root{
      ...
      --chip-bg:#f1f5f9;      /* gris claro */
      --surface:#ffffff;
      --bg:#f6faff;           /* fondo suave */
    ...
    /* Wrapper principal que replica la tarjeta grande del mockup */
    .auth-shell{
    ...
    .brand-badge i{
      ...
      border-radius:999px;
      background:#dbe6ff;
      box-shadow: inset 0 0 0 1px #c7d7ff;
      font-style:normal;
    }
    ...
    /* Borde/acento azul del mockup */
    .right-pane::before{
      content:"";
      position:absolute; inset:0 0 0 auto;
      width:6px; background: var(--brand);
      box-shadow: 0 0 0 1px rgba(19,99,255,.15) inset;
    }
    ...
    .toggle-pass{
      position:absolute; right:14px; top:70%;
      transform:translateY(-50%); cursor:pointer; opacity:.6;
    }
...
<body>
  <div class="d-flex align-items-center justify-content-center min-vh-100 px-3">
    <div class="auth-shell">
      ...
      <div class="right-pane">
        <h2 class="form-title mb-1"><span class="lock">🔒</span> Registro</h2>
        <div class="subtle">Usa tus datos para crear una cuenta de administrador o empleado.</div>

        <form action="procesar_registro.php" method="POST" class="mt-3">
          <div class="mb-3">
          ...
          <div class="mb-3 position-relative">
            ...
            <input id="pass" type="password" class="form-control pe-5" name="contrasena" placeholder="Ingresa una contraseña segura" required>
  ...
  <script>
    ...
    toggle?.addEventListener('click', () => {
      ...
      toggle.style.opacity = pass.type === 'text' ? 1 : .6;
    });
  </script>
</body>
</html>
